...
const EditMovie = () => {
    ...
    useEffect(() => {
        const fetchMovieData = async () => {
            try {
                const response = await axios.get(`http://127.0.0.1:5002/api/getMovie/${movieId}`);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const backendResponse = await axios.put(`http://127.0.0.1:5002/api/movieEdit/${movieId}`, formData);
    ...
    return (
        <div>
            <div>
                <h1 className='text-3xl font-bold text-center my-8'>Edit Movie Data</h1>
            </div>
